...
func (m *MockSerializer) DataRebind(arg0, arg1 interface{}) error {
	m.ctrl.T.Helper()
...
func (mr *MockSerializerMockRecorder) DataRebind(arg0, arg1 interface{}) *gomock.Call {
...
func (m *MockSerializer) Deserialize(arg0 []byte, arg1 interface{}) error {
	m.ctrl.T.Helper()

...
type SliceTestData struct {
	...
	StructList     []*SliceItem `protobuf:"bytes,3,rep,name=struct_list,json=structList,proto3" json:"struct_list,omitempty"`
	StructNilList  []*SliceItem `protobuf:"bytes,4,rep,name=struct_nil_list,json=structNilList,proto3" json:"struct_nil_list,omitempty"`
	BytesBytesList [][]byte     `protobuf:"bytes,5,rep,name=bytes_bytes_list,json=bytesBytesList,proto3" json:"bytes_bytes_list,omitempty"`
}
...
var file_item_item_messages_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_item_item_messages_proto_goTypes = []any{
	...
	nil,                    // 7: item.MapTestData.Int64KeyMapInt64ValueEntry
	nil,                    // 8: item.MapTestData.StrKeyMapStrValueEntry
}
var file_item_item_messages_proto_depIdxs = []int32{
	...
	7, // 4: item.MapTestData.int64_key_map_int64_value:type_name -> item.MapTestData.Int64KeyMapInt64ValueEntry
	8, // 5: item.MapTestData.str_key_map_str_value:type_name -> item.MapTestData.StrKeyMapStrValueEntry

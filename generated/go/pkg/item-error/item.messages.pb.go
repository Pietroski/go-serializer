...
var file_item_error_item_messages_proto_goTypes = []interface{}{
...
func file_item_error_item_messages_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_item_error_item_messages_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ItemError); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
